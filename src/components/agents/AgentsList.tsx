/**
 * @module components/agents/AgentsList
 * @description List component for displaying project agents with selection and delete actions
 *
 * PURPOSE:
 * - Display all agents for the current project
 * - Allow selecting an agent for editing
 * - Provide delete action for each agent
 * - Show "New Agent" button
 *
 * DEPENDENCIES:
 * - @/types/agent - Agent type
 * - @/components/ui/badge - Badge component for tier
 *
 * EXPORTS:
 * - AgentsList - Project agents list component
 *
 * PATTERNS:
 * - Similar to SkillsList component
 * - Selected agent is highlighted
 * - Delete button with confirmation
 *
 * CLAUDE NOTES:
 * - Agents are sorted by usage count (most used first)
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-xs text-neutral-600">
                    Used {agent.usageCount} time{agent.usageCount !== 1 ? "s" : ""}
                  </p>
                </div>
                <button
