 ...
 *
 * PATTERNS:
 * - User types prompt, clicks "Analyze" to score quality
 ...
 *
 * CLAUDE NOTES:
 * - Analyze button is disabled while analyzing or when prompt is empty
    ...
    <div className="space-y-4 rounded-lg border border-neutral-800 bg-neutral-900 p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-neutral-500">
            Review, Analyze, List, Plan, Handoff
          </p>
        </div>
        {analysis && (
          <button
      ...
      <div>
        <textarea
          ...
          placeholder="Describe your task... e.g., 'Implement a new function calculate_trend in src/core/health.rs that returns health score trends over the last 7 days.'"
          rows={5}
          className="w-full resize-y rounded-md border border-neutral-700 bg-neutral-800 px-3 py-2 text-sm text-neutral-200 placeholder-neutral-600 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600"
        />
      </div>
